...
export const ServerHealthMonitor: React.FC = () => {
    ...
    // Live update simulation ONLY if we have initial data (active monitoring)
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            setLocalHistory(prev => {
                ...
                // Random walk simulation for demo liveliness
    ...
    if (localHistory.length === 0 && services.length === 0) {
        return (
            <div className="h-full bg-slate-950 p-8 flex flex-col justify-center">
                <EmptyGrid 
                    title="Infrastructure Monitor Offline" 
                    description="No telemetry data detected. Activate system monitoring agents to view server health."
                    icon={Activity}
                />
            </div>
        );
    ...
    return (
        <PageLayout
            ...
            subtitle="Cluster Health & Uptime Monitoring"
            icon={Activity}
        ...
        >
            <div className="h-full p-6 md:p-8 flex flex-col overflow-y-auto">
                     ...
                     <div className="flex-1 overflow-auto">
                         <table className="w-full text-left border-collapse">
                             ...
                             <tbody className="text-slate-300 text-sm divide-y divide-slate-800/50">
                                 ...
                                 {services.length === 0 && (
                                     <tr><td colSpan={4} className="p-8 text-center text-slate-500 italic">No active services monitored.</td></tr>
                                 )}
                             </tbody>
                         </table>
                     </div>

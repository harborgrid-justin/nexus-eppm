...
export const SidebarHeader: React.FC = () => {
    ...
    return (
        <div className="h-16 flex items-center px-6 border-b border-slate-800 bg-slate-950 flex-shrink-0">
          <div className="flex items-center gap-3 text-white overflow-hidden">
            ...
            <div className="flex flex-col min-w-0">
               ...
               <span className="text-[10px] text-slate-500 uppercase tracking-widest truncate">Enterprise</span>
            </div>
          </div>
        </div>
    );

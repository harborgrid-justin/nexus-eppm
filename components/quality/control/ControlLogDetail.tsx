...
import { CheckSquare, Square, X, Camera, MessageSquare, FileText } from 'lucide-react';
        ...
        <div className="flex-1 flex flex-col bg-slate-50 h-full overflow-hidden border-l border-slate-200">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Inspection Summary</h4>
                    <p className="text-sm text-slate-700 mb-4">{report.summary}</p>
                    ...
                    {checklist ? (
                        ...
                        <div className="p-4 bg-slate-50 rounded border border-dashed border-slate-200 text-center text-slate-400 text-sm flex flex-col items-center">
                            <FileText size={24} className="mb-2 opacity-50"/>
                            No detailed checklist attached to this report record.
                        </div>
                    )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                     <div className="bg-white p-4 rounded-xl border border-slate-200 flex items-center gap-3">
                         ...
                         <div>
                             <p className="font-bold text-slate-800">{checklist ? checklist.photos : 0} Photos</p>

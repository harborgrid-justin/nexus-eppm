        ...
        <div className="space-y-8 animate-in fade-in duration-300 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-slate-500 mt-1">Billed annually • Renewal: {billing.renewalDate}</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-xs font-bold text-slate-900">{seatCount} / {billing.seatLimit}</span>
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-xs font-bold text-slate-900">{storageUsed.toFixed(1)} GB / {billing.storageLimitGB} GB</span>
                    </div>
            ...
            <div className="bg-indigo-900 rounded-3xl p-6 md:p-10 text-white relative overflow-hidden flex flex-col lg:flex-row justify-between items-center gap-10 shadow-2xl">
                <div className="relative z-10 space-y-4 text-center lg:text-left w-full">
                    ...
                    <p className="text-indigo-200 max-w-lg leading-relaxed mx-auto lg:mx-0">As an {billing.licenseType} member, you have a dedicated Account Executive and priority access to our PMO Engineering team for custom data migrations.</p>

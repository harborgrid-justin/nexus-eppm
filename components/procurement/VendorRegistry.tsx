...
import { Search, Filter, ShieldCheck, AlertCircle, Ban } from 'lucide-react';
        ...
        <div className="p-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
            <div className="flex gap-2">
                <div className="relative">
                    ...
                    <input type="text" placeholder="Search vendors..." className="pl-9 pr-4 py-1.5 border border-slate-300 rounded-md text-sm w-64" />
                </div>
                <button className="px-3 py-1.5 bg-white border border-slate-300 rounded-md text-sm flex items-center gap-2"><Filter size={14}/> Status</button>
            </div>
            <button className="px-4 py-2 bg-nexus-600 text-white rounded-md text-sm font-medium">Add Vendor</button>
        </div>
                        ...
                        <tr key={v.id} className="hover:bg-slate-50">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-bold">{v.performanceScore}</span>
                                </div>
                            </td>

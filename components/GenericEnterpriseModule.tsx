...
import { Construction, ClipboardList, HardHat, GraduationCap, Archive, AlertCircle, RefreshCw } from 'lucide-react';
       ...
       <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">
              <Icon className="text-nexus-600" /> {title}
            </h1>
          ...
          <div className="flex gap-2">
             ...
             <button className="px-4 py-2 bg-nexus-600 text-white rounded-lg shadow-sm text-sm font-medium hover:bg-nexus-700">
                Actions
             </button>
          </div>
       </div>
       ...
       <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex-1 flex flex-col overflow-hidden relative">
          ...
          <div className="absolute inset-0 bg-slate-50/50 backdrop-blur-[1px] z-10 flex flex-col items-center justify-center text-center p-8">
             ...
             <p className="text-slate-500 max-w-md mb-6">
                The <span className="font-semibold text-nexus-600">{title}</span> module is active in the local environment. Connect an enterprise data source or license key to populate real-time records.
             </p>
             <div className="flex gap-3">
                ...
                <button className="px-4 py-2 bg-nexus-600 rounded-md text-sm font-medium text-white">Connect Data Source</button>
             </div>
          </div>

        ...
        >
            <div className="space-y-6">
                <div className="p-4 bg-amber-50 border border-amber-100 rounded-2xl flex items-start gap-3">
                    ...
                    <span className="text-xs text-amber-900 leading-relaxed font-medium">Applying a template will overwrite current plan sections.</span>
                </div>

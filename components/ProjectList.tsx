...
const ProjectList: React.FC = () => {
  ...
  return (
    <div className={`${theme.layout.pagePadding} ${theme.layout.sectionSpacing} h-full flex flex-col w-full max-w-[var(--spacing-container)] mx-auto ${theme.colors.background}`}>
      <PageHeader 

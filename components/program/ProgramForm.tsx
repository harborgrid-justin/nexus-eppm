            ...
            <div className="space-y-6 animate-nexus-in">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select 
                            className={`w-full p-2.5 border ${theme.colors.border} rounded-xl text-sm ${theme.colors.surface} focus:ring-2 focus:ring-nexus-500 outline-none`}
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div>
                         ...
                         <select className={`w-full p-2.5 border ${theme.colors.border} rounded-xl text-sm ${theme.colors.surface} focus:ring-2 focus:ring-nexus-500 outline-none`} value={formData.status} onChange={e => setFormData({...formData, status: e.target.value as any})}>
                    ...
                    <div>
                         ...
                         <select className={`w-full p-2.5 border ${theme.colors.border} rounded-xl text-sm ${theme.colors.surface} focus:ring-2 focus:ring-nexus-500 outline-none`} value={formData.health} onChange={e => setFormData({...formData, health: e.target.value as any})}>
                    ...
                    <div>
                        ...
                        <select className={`w-full p-2.5 border ${theme.colors.border} rounded-xl text-sm ${theme.colors.surface} focus:ring-2 focus:ring-nexus-500 outline-none`} value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})}>
                ...
                <div>
                    ...
                    <textarea 
                        className={`w-full p-4 border ${theme.colors.border} rounded-2xl text-sm h-32 focus:ring-4 focus:ring-nexus-500/10 focus:border-nexus-500 outline-none ${theme.colors.surface} transition-all shadow-inner bg-slate-50/50`}

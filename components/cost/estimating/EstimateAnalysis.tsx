...
export const EstimateAnalysis: React.FC<EstimateAnalysisProps> = ({ estimate, chartData, colors, estimateClasses }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 h-full">
        <div className={`${theme.components.card} p-6 flex flex-col`}>
        ...
        <div className={`${theme.components.card} p-6 flex flex-col`}>
            ...
            <div className="space-y-4 flex-1">
                <div className={`p-4 ${theme.colors.background} rounded-lg flex justify-between items-center border ${theme.colors.border}`}>

        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className={`${theme.components.card} p-6`}>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className={`text-sm text-slate-500 ${theme.colors.background} p-3 rounded-lg max-w-[150px]`}>
            ...
            <div className={`${theme.colors.background} border ${theme.colors.border} rounded-xl p-4`}>
                <h4 className="text-sm font-bold text-slate-800 mb-2">Scope Impact Statement</h4>
                <textarea 
                    className={`w-full p-3 ${theme.colors.surface} border border-slate-300 rounded-lg text-sm h-24`}
